              ...
              Padding(
               ...
               Card(
                 color:Colors.white,
                   ...
                   IconButton(
                     onPressed: (){
                       launchUrl(Uri.parse("https://www.facebook.com/techhack9/"));
                     },
                     color: Colors.blue,
                    ...
                    IconButton(
                     onPressed: (){launchUrl(Uri.parse("https://twitter.com/sp_techz"));},
                     color: Colors.blue,
                    ...
                    IconButton(
                     onPressed: (){launchUrl(Uri.parse("https://www.youtube.com/channel/UCnrx0DroNBhbB9Ofo6ozmyQ"));},
                     color: Colors.red,
                    ...
                    IconButton(
                     onPressed: (){launchUrl(Uri.parse("https://np.linkedin.com/in/sajan-poudel-722105158"));},
                     color: Colors.blue,
