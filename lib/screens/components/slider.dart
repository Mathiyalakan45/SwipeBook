          ...
          DrawerHeader(
            ...
            ListTile(
             onTap:(){ Navigator.push(context, MaterialPageRoute(
              ...
              ///////////////
               ListTile(
              onTap:(){ launchUrl(Uri.parse("https://play.google.com/store/apps/details?id=np.sajanpoudel.Techbook"));
              },
              ...
              title: Text("Rate"),
               ...
               ListTile(
                 onTap:(){ 
              SharePlus.instance.share(ShareParams(text: "Download this app from https://play.google.com/store/apps/details?id=np.sajanpoudel.Techbook"));
              },
